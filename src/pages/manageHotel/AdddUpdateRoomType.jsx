        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <Box>
                ...
                <Box item sx={{ display: "flex", justifyContent: "space-between" }}>
                    <Typography sx={{ color: "#34495e", fontWeight: 500, fontSize: { xs: "1rem", sm: "1.3rem" } }}>
                        {id === 'add' ? 'Add Room Type' : `Update Room Type - ${originalData?.roomName}`}
                    </Typography>
                    <Link to="/">
                        <Button startIcon={<ArrowBackIcon />} variant="outlined" sx={{ color: "#ffffff", border: "1px solid #0D6A84", p: "8px 16px", ":hover": { backgroundColor: "#0D6A84", color: "white" }, transition: "all 0.3s ease", backgroundColor: '#0D6A84' }}>
                            Back
                        </Button>
                    </Link>
                </Box>
                ...
                <Accordion defaultExpanded sx={{ mt: 3, borderRadius: 0, overflow: 'hidden' }}>
                    <AccordionSummary sx={{ backgroundColor: "#0D6A8426", }} expandIcon={<ExpandMoreIcon />}>
                        <Typography sx={{ color: "#2C2C2C", fontWeight: 400, fontSize: "1rem" }}>
                            General Information
                        </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                ...
                {/* Bed Per Room Accordion */}
                <Accordion sx={{ mt: 2, overflow: 'hidden' }}>
                    <AccordionSummary sx={{ backgroundColor: "#0D6A8426", }} expandIcon={<ExpandMoreIcon />}>
                        <Typography sx={{ color: "#2C2C2C", fontWeight: 400, fontSize: "1rem" }}>
                            Bed Per Room
                        </Typography>
                ...
                {/* Main Image and Description Accordion */}
                <Accordion sx={{ mt: 2, overflow: 'hidden' }}>
                    <AccordionSummary sx={{ backgroundColor: "#0D6A8426", }} expandIcon={<ExpandMoreIcon />}>
                        <Typography sx={{ color: "#2C2C2C", fontWeight: 400, fontSize: "1rem" }}>
                            Media Content
            ...
            /> */}
                ...
                <Accordion sx={{ mt: 2, overflow: 'hidden' }}>
                    ...
                    <AccordionDetails>
                        {/* Your existing Cancellation Policy content */}
                ...
                <Box sx={{ bgcolor: "#fff", mt: 3, borderRadius: 2, p: 1 }}>
                    <Button type="submit" fullWidth variant="contained" sx={{ backgroundColor: "#0D6A84", color: "#ffffff", ":hover": { backgroundColor: "#0D6A84" }, padding: "10px 0" }}>
                        {id === 'add' ? 'Create Room Type' : 'Update Room Type'}
                    </Button>
                </Box>
