import { Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, Divider, Grid2, IconButton, Paper, Stack, TextField, Typography } from "@mui/material";
import CheckIcon from "@mui/icons-material/Check";
import BlockIcon from "@mui/icons-material/Block";
import InsertDriveFileOutlinedIcon from "@mui/icons-material/InsertDriveFileOutlined";
import { useParams } from "react-router-dom";
import { useState } from "react";
import { data } from "../Components/PendingPayments";
const PaymentDetailsPage = () => {
    ...
    return (
        <Box sx={{ bgcolor: "#f3f3f9", minHeight: { xs: "100%", sm: "100vh" } }}>
            <Box
                sx={{
